...
parser.add_argument('-f', '--fasta', metavar='fasta', \
    required=True, nargs=1, help="fasta with unclustered probes")
parser.add_argument('-o', '--output', metavar='fasta', \
    required=True, nargs=1, help="output fasta with clustered probes")
...
parser.add_argument('-t', '--max_terminal_mismatches', \
    required=True, nargs=1, help='Max terminal mismatches \
